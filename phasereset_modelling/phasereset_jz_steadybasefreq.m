function [signal,phaseatstart,newfreq] = phasereset_jz_steadybasefreq (time, fsample, wavefr, minfr, maxfr, startpos, resetpos, numones)
...
phaseatreset=acos(mean([cos(phaseatstart) 0.5*ones(1,numones)]));  % aiming for phase of 0degrees 
